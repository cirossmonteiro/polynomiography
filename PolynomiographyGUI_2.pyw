...
class App:
    def __init__(self,window):
        ...
        self.label_9 = Label(self.midframe2,text='roots')
        self.label_9.grid(row=6,column=0,padx=1,pady=1,sticky=E)
        self.entry_9 = Entry(self.midframe2,width = 8)
        self.entry_9.grid(row = 6,column = 1,padx = 1,pady = 1)
        self.entry_9.insert(0,self.default9)
 ...
 sequences',command = self.basic)
        ...
        self.button_2.grid(row=2,column=0,padx=1,pady=1,sticky=\
                           W+E)
        self.button_3 = Button(self.midframe3,text='Inter. Basins of Attr.'\
                               ,command = self.interBasins)
        self.button_3.grid(row=3,column=0,padx=1,pady=1,sticky=\
                           W+E)
        self.button_4 = Button(self.midframe3,text='Reset'\
                               ,command = self.reset)
        self.button_4.grid(row=4,column=0,padx=1,pady=1,sticky=\
                           W+E)
...
(n>0)')
    ...
    def getParameters(self):
        ...
        if err != 0:
            return (0,err,0)
        return inputmethod,inp,m,n,xmin,xmax,ymin,ymax,step,err,roots
...
documentation for more info.")
    ...
    def interBasins(self):
        param = self.getParameters()       
        PLOT.drawRoots(param[-1],param[3],param[2],param[4],\
                                param[5],param[6],param[7])
